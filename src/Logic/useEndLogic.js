...
function useEndLogic() {
  ...
  const jerryCard = (
    <div className="end-text-box">
      ...
      <div className="text-box">
        <span className="end-card-text">
          Hey buddy, you did the best you could. Wanna Smore?
        </span>
      </div>
    </div>
  );
  ...
  const pickleCard = (
    <div className="end-text-box">
      ...
      <div className="text-box">
        <span className="end-card-text">
          The reason anyone would do this is, if they could, which they can't,
  ...
  const endText =
    score < 1000
      ...
      ? meeseeksCard
      : score >= 10000 && score < 50000
      ? summerCard
      : score >= 50000 && score < 150000
      ? bethCard
      : pickleCard;
